...
Wegner 最早给出有界量化的程序示例，Cardelli（1988a）在幂种类研究中给出
更多示例。Curien 与 Ghelli（1992；Ghelli，1990）研究了 \(F_{<:}\) 的若干
句法性质；Bruce 与 Longo、Martini、Breazu-Tannen 等、Cardone、Cardelli
与 Longo、Cardelli 等、Curien 与 Ghelli、Bruce 与 Mitchell 等工作研究了
密切相关系统的语义方面。带记录和更丰富继承形式的扩展，以及 Quest、Abel、
GJ、Pict 与 Funnel 等语言设计，也都使用了有界量化。
