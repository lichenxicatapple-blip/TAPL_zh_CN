...
\begin{proof}
由\taplnamedref{thm:22.3.5}{定理22.3.5}和
\taplnamedref{thm:22.3.7}{定理22.3.7}。
\end{proof}
...
\begin{proof}
由\taplnamedref{cor:22.3.8}{推论22.3.8}和
\taplnamedref{thm:22.5.3}{定理22.5.3}。
\end{proof}

\begin{exercise}[推荐，\(\star\star\star\)]
\label{ex:22.5.5}
结合\taplnamedref{ex:22.3.10}{练习22.3.10}的约束生成与
\taplnamedref{ex:22.4.6}{练习22.4.6}的合一算法，以
