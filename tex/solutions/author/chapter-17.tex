...
let rec join tyS tyT =
  ...
  | _ ->
      TyTop
\end{taplocamlcode}
\taplocamlgroupedcounterpart{sol-author-17-join}
...
and meet tyS tyT =
  ...
  | _ ->
      raise Not_found
\end{taplocamlcode}
\taplocamlgroupedcounterpart{sol-author-17-meet}
...
\end{taplocamlcode}
\taplocamlgroupedcounterpart{sol-author-17-conditional-type}

相应的 Rust 对照实现如下。为使代码能够独立阅读，先给出所需的类型定义：

\taplrustsupport{sol-author-17-join-support}
\taplrustcounterpart[page]{sol-author-17-join}
\taplrustcounterpart[page]{sol-author-17-meet}
\taplrustcounterpart[page]{sol-author-17-conditional-type}
