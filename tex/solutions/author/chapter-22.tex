...
\inferrule*[right=CT-Proj]
 {\Gamma\vdash t_0:T\mid_{\mathcal X}C}
 {\Gamma\vdash t_0.l_i:X\mid_{\mathcal X\cup\{X,\sigma,\rho\}}
  C\cup\{T=\{\rho\},\rho=(l_i:X)\oplus\sigma\}}
\]
含义是：只要 \(t_0\) 的记录行 \(\rho\) 包含 \(l_i:X\)，其余字段由 \(\sigma\)
