...
定义；\texttt{Object} 不得在类表中重复声明；继承图无环；字段不遮蔽继承字段；
同一类中字段名、方法名与方法形参名均不重复。
...
\taplrustsupportchunk{ch19-fj-class-table}{151}{190}
...
错误、继承环、未定义的类名、重复方法形参、保留名称 \texttt{this}，以及非法重定义
\texttt{Object}。源码与测试共同参与整书构建，因而书内片段与实际验证的实现保持
一致。
...
下面给出参与编译和测试的泛型语法、类表检查、带界类型检查及擦除执行实现。配套
测试覆盖无泛型程序回归、泛型容器、泛型方法、通过上界查询成员、继承时改变类型
实参、递归上界、上界违反、方法体类型错误、非法泛型覆盖、保留类名，以及擦除后
需要插入转换的方法体和链式成员调用。
...
\taplrustsupportchunk{ch19-gj}{331}{360}
\taplrustsupportchunk{ch19-gj}{361}{390}
\taplrustsupportchunk{ch19-gj}{391}{420}
\taplrustsupportchunk{ch19-gj}{421}{450}
\taplrustsupportchunk{ch19-gj}{451}{480}
\taplrustsupportchunk{ch19-gj}{481}{510}
\taplrustsupportchunk{ch19-gj}{511}{540}
\taplrustsupportchunk{ch19-gj}{541}{570}
\taplrustsupportchunk{ch19-gj}{571}{600}
\taplrustsupportchunk{ch19-gj}{601}{630}
\taplrustsupportchunk{ch19-gj}{631}{660}
\taplrustsupportchunk{ch19-gj}{661}{690}
\taplrustsupportchunk{ch19-gj}{691}{718}
